...
import (
    ...
    "github.com/dalecosta1/sinaloa-cli/cmd/storj/be"
    ...
    Run: func(cmd *cobra.Command, args []string) {
        ...
        if getSecret == "" {
            helpers.HandleResponseError(
                "An error occurred at 'github.com/dalecosta1/sinaloa-cli/cmd/storj/sub/get' inside method 'GetStorjCmd': Required flag not set: secret",
                "500",
                nil,
            )
            return
        ...
        if err != nil {
            helpers.HandleResponseError(
                "An error occurred at 'github.com/dalecosta1/sinaloa-cli/cmd/storj/sub/get' inside method 'GetStorjCmd' calling the function be 'uplink.NewStorjService(getSecret)'",
                "500",
                err,
            )
            return
        ...
        if err != nil {
            helpers.HandleResponseError(
                "An error occurred at 'github.com/dalecosta1/sinaloa-cli/cmd/storj/sub/get' inside method 'GetStorjCmd' calling the function be 'uplink.storjService.GetFile(getBucket, getPath)'",
                "500",
                err,
            )
            return
		...
		if err != nil {
			helpers.HandleResponseError(
				"An error occurred at 'github.com/dalecosta1/sinaloa-cli/cmd/storj/sub/get' inside method 'GetStorjCmd' calling the function be 'utils.ExtractFileName(getPath)'",
				"500",
				err,
			)
			return
		...
		if err != nil {
			helpers.HandleResponseError(
				"An error occurred at 'github.com/dalecosta1/sinaloa-cli/cmd/storj/sub/get' inside method 'GetStorjCmd' calling the function be 'utils.ExtractFileExtension(getPath)'",
				"500",
				err,
			)
			return
        ...
        if getPathLocal != "" {
            ...
            if err != nil {
                helpers.HandleResponseError(
                    "An error occurred at 'github.com/dalecosta1/sinaloa-cli/cmd/storj/sub/get' inside method 'GetStorjCmd' calling the function be 'utils.SaveFileLocally(getPathLocal, data)'",
                    "500",
                    err,
                )
                return
        ...
        if err != nil {
            helpers.HandleResponseError(
                "An error occurred at 'github.com/dalecosta1/sinaloa-cli/cmd/storj/sub/get' inside method 'GetStorjCmd' while marshaling JSON",
                "500",
                err,
            )
            return
