    ...
    Run: func(cmd *cobra.Command, args []string) {
        ...
        if deleteSecret == "" {
            helpers.HandleResponseError(
                "An error occurred at 'github.com/dalecosta1/sinaloa-cli/cmd/storj/sub/delete' inside method 'DeleteStorjCmd': Required flag not set: secret",
                "500",
                nil,
            )
            return
        ...
        if err != nil {
            helpers.HandleResponseError(
                "An error occurred at 'github.com/dalecosta1/sinaloa-cli/cmd/storj/sub/delete' inside method 'DeleteStorjCmd' calling the function be 'NewStorjService(deleteSecret)'",
                "500",
                err,
            )
            return
        ...
        if err != nil {
            helpers.HandleResponseError(
                "An error occurred at 'github.com/dalecosta1/sinaloa-cli/cmd/storj/sub/delete' inside method 'DeleteStorjCmd' calling the function be 'storjService.DeleteFile(deleteBucket, deletePath)'",
                "500",
                err,
            )
            return
        ...
        if err != nil {
            helpers.HandleResponseError(
                "An error occurred at 'github.com/dalecosta1/sinaloa-cli/cmd/storj/sub/delete' inside method 'DeleteStorjCmd' while marshaling JSON",
                "500",
                err,
            )
            return
